...
public function downloadMcqPaperold($testId)
{
    ...
    $filename = preg_replace('/[^A-Za-z0-9\-]/', '_', $test->title) . '-question-paper.pdf';
    // if (ob_get_length()) {
    //     ob_end_clean();
    // }
    $mpdf = new Mpdf([
    ...
    $html = view('pdf.questions_pdf', compact('test', 'questions'))->render();

    // 🔥 THIS IS THE KEY DIFFERENCE FROM YOUR BROKEN VERSION
