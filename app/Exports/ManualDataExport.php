...
class ManualDataExport implements FromCollection, WithHeadings, WithMapping, ShouldAutoSize
{
    ...
    public function collection()
    {
            ...
            $q->selectRaw('1')
                ...
                ->whereRaw(
                    'BINARY blocked_numbers.number =
                     BINARY manual_data.student_mobile'
                );
        ...
        // → SKIP
        //
        // This applies even if their session is 45 days.
        //
        ...
        $query->where(function ($manualQuery) {
            ...
            $manualQuery->whereNotExists(function ($q) {
            ...
            $manualQuery->orWhere(function ($q) {
        ...
        // No exclusion here.
        //
        // If the student had an old 45-day session,
        // they remain eligible.
        //
        // If they joined within 90 days,
        // Rule #2 already excluded them.
        //
