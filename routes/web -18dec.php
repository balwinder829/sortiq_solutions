...
Route::middleware(['auth', 'role:1,2,3'])->get('/dashboard', [DashboardController::class, 'index'])
    ->name('dashboard');
...
Route::middleware(['auth', 'role:1'])->get('/manager/students', [StudentController::class, 'managerIndex'])
