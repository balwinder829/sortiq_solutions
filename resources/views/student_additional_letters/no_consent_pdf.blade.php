    ...
    <div class="certi-body" style=" background:url('{{ public_path('images/certificates_images/bg-shape.jpg') }}')  no-repeat center; background-size:860px; padding-top: 60px;">
        <div class="inner-container" style="padding-left: 30px; padding-right: 30px;">
            ...
            <table width="100%" cellpadding="0" cellspacing="0" style="margin-top:35px;">
                ...
                <tr>
                    <td colspan="2" style="font-size: 14px; line-height: 24px; padding-bottom:15px; font-family: 'Inter', sans-serif;">
                       <b> I, {{ ucwords($letter->student->student_name) }} son/daughter of Mr {{ ucwords($letter->student->f_name ?? '-') }}, pursuing Industrial Training/Internship from Sortiq Solutions Pvt. Ltd. in {{ ucwords($letter->student?->courseData?->course_name ?? 'N/A') }} Technology declare you not to make me appear in the Screening Interviews.
