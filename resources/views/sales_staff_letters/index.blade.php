...
<div class="container">
    ...
    <div class="row mb-4">
        <div class="col-md-6">
            <h1 class="page_heading">Sales Staff Letters</h1>
        </div>

        <div class="col-md-6">
            <div class="d-flex justify-content-end">
                <a href="{{ route('sales-staff-letters.create') }}"
                   class="btn"
            ...
            <tr>
                ...
                <td>
                    ...
                    <div class="d-flex gap-1">
                        ...
                        <a href="{{ route('sales-staff-letters.edit', $letter) }}"
                           class="btn btn-sm">
                            <i class="fas fa-edit"></i>
                        </a>

                        <a href="{{ route('sales-staff-letters.download', $letter) }}"
                           class="btn btn-sm">
                            <i class="fas fa-download"></i>
                        </a>

                        <!-- <form action="{{ route('sales-staff-letters.email', $letter) }}"
                              method="POST"
                        ...
                        <form action="{{ route('sales-staff-letters.destroy', $letter) }}"
                              method="POST"
                              style="display:inline;"
