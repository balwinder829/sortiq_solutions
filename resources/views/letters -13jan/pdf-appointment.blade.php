	...
	<div class="certi-body" style=" background:url('../images/bg-shape.jpg')  no-repeat center; background-size:860px; padding-top: 60px;">
		<div class="inner-container" style="padding-left: 30px; padding-right: 30px;">
			...
			<table width="100%" cellpadding="0" cellspacing="0" style="margin-top:35px;">
				...
				<tr>
					<td align="left" style="font-size: 14px; line-height: 24px; text-align:left; font-family: 'Inter', sans-serif;">
						<strong>Emp Code:</strong> {{ ucwords($letter->emp_code) }}
					</td>
				</tr>
				<tr>
					<td align="left" style="font-size: 14px; line-height: 24px; text-align:left; font-family: 'Inter', sans-serif;">
						<strong>Address:</strong> {{ ucwords($letter->address ?? '') }}
					</td>
				</tr>
				<tr>
					<td align="left" style="font-size: 14px; line-height: 24px; text-align:left; font-family: 'Inter', sans-serif;">
			...
			<table width="100%" cellpadding="0" cellspacing="0" style="margin-top:35px;">
				<tr>
					<td colspan="2" style="font-size: 14px; line-height: 24px; padding-bottom:15px; font-family: 'Inter', sans-serif;">
						<strong>Employment Terms:</strong> You are bonding with the company for a minimum period of {{ ucwords($letter->bond_period) }} year and the
							offered Salary Rs. <strong>{{ is_numeric($letter->salary) ? number_format($letter->salary, 2) : 'N/A' }}</strong>/- per month subjected to statutory deduction & TDS (If Applicable). You will
				...
				<tr>
					<td colspan="2" style="font-size: 14px; line-height: 24px; padding-bottom:15px; font-family: 'Inter', sans-serif;">
						<strong>Probation Period:</strong>{{ ucwords($letter->probation_period ?? '3') }} Months will be The Probation Period in which if the
