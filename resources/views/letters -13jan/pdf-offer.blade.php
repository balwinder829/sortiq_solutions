	...
	<div class="certi-body" style=" background:url('{{ public_path('images/certificates_images/bg-shape.jpg') }}')  no-repeat center; background-size:860px; padding-top: 60px;">
		<div class="inner-container" style="padding-left: 30px; padding-right: 30px;">
			...
			<table width="100%" cellpadding="0" cellspacing="0" style="margin-top:35px;">
				...
				<tr>
					<td colspan="2" style="font-size: 14px; line-height: 24px; padding-bottom:5px; font-family: 'Inter', sans-serif;">
						Dear <strong>{{ ucwords($letter->emp_name) }}</strong>,
					</td>
				</tr>
				<tr>
					<td colspan="2" style="font-size: 14px; line-height: 24px; padding-bottom:15px; font-family: 'Inter', sans-serif;">
						With reference to your application and subsequent interview, we are delighted to extend an offer to you to join Sortiq Solutions Pvt. Ltd. as position of <strong>{{ ucwords($letter->position) }}</strong> effective from <strong>{{ \Carbon\Carbon::parse($letter->joining_date)->format('d M Y') }}.</strong> Your salary package will be Rs. <strong>{{ is_numeric($letter->salary) ? number_format($letter->salary, 2) : 'N/A' }}</strong>/- per month (With applicable taxes).
					</td>
				</tr>
				<tr>
					<td colspan="2" style="font-size: 14px; line-height: 24px; padding-bottom:15px; font-family: 'Inter', sans-serif;">
