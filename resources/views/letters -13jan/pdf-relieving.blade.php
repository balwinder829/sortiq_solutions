			...
			<table width="100%" cellpadding="0" cellspacing="0" style="margin-top:35px;">
				...
				<tr>
					<td colspan="2" style="font-size: 14px; line-height: 24px; padding-bottom:15px; font-family: 'Inter', sans-serif; text-align: justify;">
						During his/her tenure, Mr./Ms. <strong>{{ ucwords($letter->emp_name) }}</strong> demonstrated dedication, professionalism, and a positive work attitude. We appreciate his/her contributions and wish him/her all the best in future endeavors.
					</td>
				</tr>
				<tr>
