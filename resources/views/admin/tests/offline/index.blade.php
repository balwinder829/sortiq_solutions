...
<div class="row mb-2">
        <div class="col-md-6">
            <h1 class="page_heading">Offline Tests</h1>
        </div>
        <div class="col-md-6">
                <div class="d-flex justify-content-end">
                    
                <a href="{{ route('admin.offline-tests.create') }}" class="btn btn-primary mb-3">
                    Add Test
                </a>
...
<div class="mb-3 d-flex flex-wrap gap-2">
    ...
    <a href="{{ route('admin.tests.export.overall.attempted') }}"
       class="btn btn-outline-primary">
        <i class="fa fa-download"></i> Overall All Students
    </a>
    ...
    {{-- OFFLINE ONLY --}}
    <a href="{{ route('admin.tests.export.offline.attempted') }}"
       class="btn btn-outline-info">
        <i class="fa fa-download"></i> Offline All Students
    </a>

    <a href="{{ route('admin.tests.export.offline.finalized') }}"
       class="btn btn-outline-warning">
        <i class="fa fa-download"></i> Offline Finalized
    </a>
...
<form method="GET" class="p-3 rounded mb-3" style="background:#f1f3f8">
    <div class="row">
        ...
        <div class="col-md-2 mb-2 d-flex align-items-end">
            <a href="{{ route('admin.offline-tests.index') }}" class="btn btn-secondary w-100">
                Reset
            </a>
        </div>
...
<tr>
  ...
  <td class="text-center">
    <div class="d-flex justify-content-center gap-1">
        ...
        <a href="{{ route('admin.offline.tests.download.mcq.paper', $test->id) }}"
        ...
        <a href="{{ route('admin.offline-tests.edit', $test->id) }}"
           class="btn btn-sm btn-outline-warning"
           data-bs-toggle="tooltip"
           title="Edit">
...
$('#marksModal').on('show.bs.modal', function (e) {
    ...
    $('#marksContent').load(`/admin/offline-tests/${testId}/selected-students`);
});
</script>
@endpush
