...
<div class="row mb-2">
    <div class="col-md-6">
        <h1 class="page_heading">Office Online Exams</h1>
    </div>

    <div class="col-md-6">
        <div class="d-flex justify-content-end">
            <a href="{{ route('admin.office-online-tests.create') }}"
...
<a 
href="{{ route('admin.office-online-tests.results',$test->id) }}" 
class="btn btn-sm btn-primary"
>
View Result
</a>
...
<a href="{{ route('admin.office-online-questions.index',$test->id) }}"
...
{{-- Edit --}}
<a href="{{ route('admin.office-online-tests.edit',$test->id) }}"
...
{{-- Delete --}}
<form action="{{ route('admin.office-online-tests.destroy',$test->id) }}"
method="POST"
class="d-inline"
