...
<div class="row mb-2">
    <div class="col-md-6">
        <h1 class="page_heading">Edit College Attendance Form</h1>
    </div>
</div>
...
<form method="POST" action="{{ route('admin.external-attendance.update', $test->id) }}">
@csrf
@method('PUT')
...
<div class="row">
    ...
    <div class="col-md-6 mb-3">
        ...
        <select name="college_ids[]"
            ...
            @php
                $selectedColleges = old(
                    'college_ids',
                    $test->links->pluck('college_id')->toArray()
                );
            @endphp
