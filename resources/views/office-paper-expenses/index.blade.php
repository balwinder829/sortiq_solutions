...
<div class="container">
    <div class="row mb-2">
        <div class="col-md-6">
            <h1 class="page_heading">Papers Expenses</h1>
        </div>
        <div class="col-md-6">
    ...
    {{-- FILTERS --}}
    <form method="GET"  id="filterForm" action="{{ route('office-paper-expenses.index') }}" class="mb-4">
        ...
        <div class="row mt-3">
            <div class="col-md-12 text-end">
               <!--  <button class="btn btn-primary">
                ...
                <a href="{{ route('office-paper-expenses.index') }}"
