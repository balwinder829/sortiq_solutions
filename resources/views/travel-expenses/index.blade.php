...
<div class="container">
    ...
    <form method="GET" action="{{ route('travel-expenses.index') }}" class="mb-4">
        ...
        <div class="row mt-3">
            <div class="col-md-12 text-end">
                ...
                <a href="{{ route('travel-expenses.index') }}"
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center">
                        ...
                        <a href="{{ route('travel-expenses.show', $expense->id) }}" class="btn btn-sm">
                            <i class="fa fa-eye"></i>
                        </a>

                        <a href="{{ route('travel-expenses.edit', $expense->id) }}" class="btn btn-sm">
