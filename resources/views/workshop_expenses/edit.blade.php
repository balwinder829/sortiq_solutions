...
<div class="container">
    ...
    <h3>Edit Workshop Expense</h3>

    <form method="POST"
          action="{{ route('workshop-expenses.update', $expense->id) }}">
        ...
        <div class="row">
                ...
                <select name="workshop_id"
                    ...
                    @foreach($workshops as $workshop)
                        <option value="{{ $workshop->id }}"
                            {{ $expense->workshop_id == $workshop->id ? 'selected' : '' }}>
            ...
            <div class="form-group col-md-3">
                ...
                <input type="number"
                       ...
                       name="expense"
                       class="form-control"
                       value="{{ old('expense', $expense->expense) }}"
                       required>
            </div>
            ...
            <div class="form-group col-md-3">
                ...
                <input type="number"
                       ...
                       name="other_expense"
                       class="form-control"
                       value="{{ old('other_expense', $expense->other_expense) }}">
            </div>
