...
<div class="col-md-2"><div class="info-box"><i class="bi bi-award"></i><h5>Fast Project Delivery</h5></div></div>
    ...
    <div class="row g-4">
      ...
      <div class="col-md-4 col-sm-6">
        <div class="card h-100 text-center shadow-sm">
          <div class="card-body">
            <i class="bi bi-shop fs-1 mb-3"></i>
            <h5>Shopify & WooCommerce Stores</h5>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-4 col-sm-6">
        <div class="card h-100 text-center shadow-sm">
          <div class="card-body">
            <i class="bi bi-globe fs-1 mb-3"></i>
            <h5>Business Websites & Custom Web Apps</h5>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-4 col-sm-6">
        <div class="card h-100 text-center shadow-sm">
          <div class="card-body">
            <i class="bi bi-plug fs-1 mb-3"></i>
