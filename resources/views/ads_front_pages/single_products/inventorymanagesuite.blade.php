...
@endif
<title>Inventory Manage Suite | Sortiq Solutions Pvt Ltd</title>
...
<section class="section about-section bg-light">
  <div class="container">
    <div class="row align-items-center g-5">
      ...
      <div class="col-md-6">
        <h2 class="section-title mb-3">
          All-in-One Inventory Management ERP
        </h2>

        <p>
          <strong>Inventory Manage Suite</strong> by <strong>SortIQ Solutions</strong> is a comprehensive ERP system designed to simplify stock management across multiple locations.
        </p>

        <p>
          It provides real-time visibility, automated workflows, and complete control over inventory operations—from purchase to sales and warehouse management.
        </p>
    ...
    <div class="text-center mt-5">
      <p class="fw-semibold">
        👉 ERP inventory systems centralize stock tracking and integrate with sales, purchase, and finance for better control and decision-making.
      </p>
    </div>
  </div>
</section>
...
<section class="section features-section">
  <div class="container">
    ...
    <h2 class="section-title text-center mb-5">
      Powerful Features for Smart Inventory Control
    </h2>
    ...
    <div class="row g-4">
      ...
      <div class="col-md-4 col-sm-6">
        <div class="card h-100 text-center shadow-sm p-3">
          ...
          <h5>Real-Time Stock Tracking</h5>
          <p>Real-Time Stock Tracking Across Locations</p>
        </div>
      </div>
      ...
      <div class="col-md-4 col-sm-6">
        <div class="card h-100 text-center shadow-sm p-3">
          ...
          <h5>Multi-Warehouse Management</h5>
          <p>Multi-Warehouse & Multi-Branch Management</p>
        </div>
      </div>

      <div class="col-md-4 col-sm-6">
        <div class="card h-100 text-center shadow-sm p-3">
          <i class="bi bi-upc-scan fs-1 mb-3"></i>
          <h5>Barcode & Batch Tracking</h5>
          <p>Barcode & Batch Tracking System</p>
        </div>
      </div>
      ...
      <div class="col-md-4 col-sm-6">
        <div class="card h-100 text-center shadow-sm p-3">
          ...
          <p>Purchase & Sales Order Management</p>
        </div>
      </div>
      ...
      <div class="col-md-4 col-sm-6">
        <div class="card h-100 text-center shadow-sm p-3">
          ...
          <p>Stock Transfers & Inventory Adjustments</p>
        </div>
      </div>
      ...
      <div class="col-md-4 col-sm-6">
        <div class="card h-100 text-center shadow-sm p-3">
          ...
          <p>Automated Reorder & Stock Alerts</p>
        </div>
      </div>
    ...
    <div class="text-center mt-5">
      <p class="fw-semibold">
        👉 ERP inventory modules provide real-time visibility and tracking of stock across warehouses and locations.
      </p>
    </div>
    ...
    <div class="row g-4">
      ...
      <div class="col-md-4 col-sm-6">
        <div class="card benefit-card border-primary h-100 text-center">
          <div class="card-body">
            ...
            <h5>Save Time</h5>
            <p>Automate inventory processes and reduce manual work</p>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-4 col-sm-6">
        <div class="card benefit-card border-success h-100 text-center">
          <div class="card-body">
            ...
            <p>Track stock levels instantly across all locations</p>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-4 col-sm-6">
        <div class="card benefit-card border-warning h-100 text-center">
          <div class="card-body">
            ...
            <h5>Reduce Stock Loss</h5>
            <p>Minimize overstocking and stock shortages</p>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-4 col-sm-6">
        <div class="card benefit-card border-danger h-100 text-center">
          <div class="card-body">
            ...
            <h5>Multi-Warehouse Control</h5>
            <p>Manage inventory across multiple warehouses easily</p>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-4 col-sm-6">
        <div class="card benefit-card border-info h-100 text-center">
          <div class="card-body">
            ...
            <h5>Automation</h5>
            <p>Automate stock updates, transfers, and reordering</p>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-4 col-sm-6">
        <div class="card benefit-card border-dark h-100 text-center">
          <div class="card-body">
            <i class="bi bi-file-earmark-text fs-1 text-dark mb-3"></i>
            <h5>Accurate Reporting</h5>
            <p>Generate detailed inventory and financial reports</p>
          </div>
        </div>
      </div>
...
<section class="section why-section bg-light">
  <div class="container">
    ...
    <h2 class="section-title text-center mb-5">
      Why Choose Inventory Manage Suite?
    </h2>
    ...
    <div class="row g-4">
      ...
      <div class="col-md-4 col-sm-6">
        <div class="card h-100 text-center shadow-sm p-3">
          <i class="bi bi-cloud fs-1 mb-3 text-success"></i>
          <h5>Cloud-Based Access</h5>
          <p>Cloud-Based & Accessible Anywhere</p>
        </div>
      </div>
      ...
      <div class="col-md-4 col-sm-6">
        <div class="card h-100 text-center shadow-sm p-3">
          ...
          <p>Integrated with Sales, Purchase & Finance</p>
        </div>
      </div>

      <div class="col-md-4 col-sm-6">
        <div class="card h-100 text-center shadow-sm p-3">
          <i class="bi bi-arrows-expand fs-1 mb-3 text-danger"></i>
      ...
      <div class="col-md-4 col-sm-6">
        <div class="card h-100 text-center shadow-sm p-3">
          <i class="bi bi-shield-check fs-1 mb-3 text-info"></i>
          <h5>Secure Data Handling</h5>
          <p>Secure & Reliable Data Handling</p>
        </div>
      </div>

      <div class="col-md-4 col-sm-6">
        <div class="card h-100 text-center shadow-sm p-3">
          <i class="bi bi-speedometer2 fs-1 mb-3 text-dark"></i>
    ...
    <div class="text-center mt-5">
      <p class="fw-semibold">
        👉 ERP systems integrate inventory with other business processes to improve efficiency and reduce errors.
      </p>
    </div>
...
<section class="section features-section">
  <div class="container">
    ...
    <div class="text-center mt-5">
      <p class="fw-semibold">
        👉 Inventory ERP connects procurement, warehouse, and sales into one system for better coordination.
      </p>
    </div>
...
<section class="section how-section">
  <div class="container">
    ...
    <h2 class="section-title text-center mb-5">
      Simple Workflow for Smart Inventory
    </h2>
      ...
      <div class="col-md-4 col-sm-6">
        <div class="card how-card text-center h-100">
          <div class="card-body">
            ...
            <i class="bi bi-building fs-1 mb-3 text-success"></i>
            <h5>Manage Warehouses & Stock Levels</h5>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-4 col-sm-6">
        <div class="card how-card text-center h-100">
          <div class="card-body">
            ...
            <i class="bi bi-cart-check fs-1 mb-3 text-warning"></i>
            <h5>Process Purchase & Sales Orders</h5>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-4 col-sm-6">
        <div class="card how-card text-center h-100">
          <div class="card-body">
            ...
            <i class="bi bi-arrow-left-right fs-1 mb-3 text-danger"></i>
            <h5>Monitor Stock Movement</h5>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-4 col-sm-6">
        <div class="card how-card text-center h-100">
          <div class="card-body">
            ...
            <h5>Analyze Reports & Optimize Inventory</h5>
          </div>
        </div>
      </div>
    ...
    <div class="row g-4 text-center">
      ...
      <div class="col-md-4 col-sm-6">
        <div class="card target-card bg-info-subtle h-100">
          <div class="card-body">
            <i class="bi bi-cart fs-1 text-info mb-3"></i>
...
<section class="section alert-section bg-light">
  <div class="container">
    ...
    <div class="row justify-content-center">
      ...
      <div class="col-md-6">
        <div class="card benefit-card border-secondary h-100 text-center">
          <div class="card-body">
            <i class="bi bi-bell fs-1 text-secondary mb-3"></i>
            <h5>Smart Stock Alerts</h5>
            <p>Get notified before stock runs out or exceeds limits</p>
          </div>
        </div>
      </div>
...
<section class="section cta-section text-center text-white">
  <div class="container">
    ...
    <h2 class="mb-3">Take Full Control of Your Inventory Today</h2>
    
    <p class="mb-4">
      Streamline operations, reduce costs, and improve accuracy with Inventory Manage Suite.
    </p>
