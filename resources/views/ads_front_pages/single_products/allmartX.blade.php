...
@endif
<title>AllmartX | Sortiq Solutions Pvt Ltd</title>
...
<section class="section about-section bg-light">
  <div class="container">
    <div class="row align-items-center g-5">
      ...
      <div class="col-md-6">
        <h2 class="section-title mb-3">
          Complete Retail & Ecommerce ERP Solution
        </h2>

        <p>
          <strong>AllmartX</strong> by <strong>SortIQ Solutions</strong> is a powerful ecommerce ERP designed for retailers, wholesalers, and online businesses.
        </p>

        <p>
          It centralizes inventory, orders, customers, and payments into one platform—helping businesses streamline operations and scale efficiently.
        </p>
    ...
    <div class="text-center mt-5">
      <p class="fw-semibold">
        👉  Modern ERP systems integrate sales, inventory, and finance into a single system to improve efficiency and decision-making.
      </p>
    </div>
  </div>
</section>
...
<section class="section features-section">
  <div class="container">
    ...
    <div class="row g-4">
      ...
      <div class="col-md-4 col-sm-6">
        <div class="card h-100 text-center shadow-sm p-3">
          ...
          <p>Order Management (Online & Offline)</p>
        </div>
      </div>
      ...
      <div class="col-md-4 col-sm-6">
        <div class="card h-100 text-center shadow-sm p-3">
          ...
          <p>Multi-Store & Multi-Channel Integration</p>
        </div>
      </div>
      ...
      <div class="col-md-4 col-sm-6">
        <div class="card h-100 text-center shadow-sm p-3">
          ...
          <p>Shipping & Delivery Tracking</p>
        </div>
      </div>
    ...
    <div class="text-center mt-5">
      <p class="fw-semibold">
        👉 ERP-based order systems allow real-time inventory tracking and multi-channel order handling.
      </p>
    </div>
...
<section class="section benefits-section">
  <div class="container">
    ...
    <h2 class="section-title text-center mb-5">
      Key Benefits for E-commerce Business
    </h2>
    ...
    <div class="row g-4">
      ...
      <div class="col-md-4 col-sm-6">
        <div class="card benefit-card border-primary h-100 text-center">
          <div class="card-body">
            ...
            <p>Manage and track all orders from one dashboard</p>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-4 col-sm-6">
        <div class="card benefit-card border-success h-100 text-center">
          <div class="card-body">
            ...
            <p>Monitor stock levels in real time across locations</p>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-4 col-sm-6">
        <div class="card benefit-card border-warning h-100 text-center">
          <div class="card-body">
            ...
            <h5>Multi-Channel Selling</h5>
            <p>Sell across website, marketplace, and POS</p>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-4 col-sm-6">
        <div class="card benefit-card border-danger h-100 text-center">
          <div class="card-body">
            ...
            <p>Track customer data, orders, and interactions</p>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-4 col-sm-6">
        <div class="card benefit-card border-info h-100 text-center">
          <div class="card-body">
            ...
            <h5>Automation</h5>
            <p>Automate billing, inventory updates, and workflows</p>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-4 col-sm-6">
        <div class="card benefit-card border-dark h-100 text-center">
          <div class="card-body">
            <i class="bi bi-bar-chart-line fs-1 text-dark mb-3"></i>
            <h5>Business Insights</h5>
            <p>Get real-time reports and performance analytics</p>
          </div>
        </div>
      </div>
...
<section class="section why-section bg-light">
  <div class="container">
    ...
    <div class="row g-4">
      ...
      <div class="col-md-4 col-sm-6">
        <div class="card h-100 text-center shadow-sm p-3">
          ...
          <h5>Centralized Operations</h5>
          <p>Centralized Ecommerce & Retail Operations</p>
        </div>
      </div>

      <div class="col-md-4 col-sm-6">
        <div class="card h-100 text-center shadow-sm p-3">
          <i class="bi bi-box fs-1 mb-3 text-success"></i>
          <h5>Real-Time Tracking</h5>
          <p>Real-Time Inventory & Order Tracking</p>
        </div>
      </div>
      ...
      <div class="col-md-4 col-sm-6">
        <div class="card h-100 text-center shadow-sm p-3">
          ...
          <p>Multi-Store & Multi-User Access</p>
        </div>
      </div>

      <div class="col-md-4 col-sm-6">
        <div class="card h-100 text-center shadow-sm p-3">
          <i class="bi bi-cloud fs-1 mb-3 text-danger"></i>
    ...
    <div class="text-center mt-5">
      <p class="fw-semibold">
        👉 Cloud ERP enables real-time access and scalable business operations.
      </p>
    </div>
...
<section class="section features-section">
  <div class="container">
    ...
    <h2 class="section-title text-center mb-5">
      Complete Ecommerce ERP Modules
    </h2>
...
<section class="section how-section">
  <div class="container">
    ...
    <h2 class="section-title text-center mb-5">
      Simple Workflow for Smart Selling
    </h2>
      ...
      <div class="col-md-4 col-sm-6">
        <div class="card how-card text-center h-100">
          <div class="card-body">
            ...
            <i class="bi bi-diagram-3 fs-1 mb-3 text-success"></i>
            <h5>Manage Orders from Multiple Channels</h5>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-4 col-sm-6">
        <div class="card how-card text-center h-100">
          <div class="card-body">
            ...
            <h5>Process Payments & Ship Orders</h5>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-4 col-sm-6">
        <div class="card how-card text-center h-100">
          <div class="card-body">
            ...
            <h5>Track Inventory & Customers</h5>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-4 col-sm-6">
        <div class="card how-card text-center h-100">
          <div class="card-body">
            ...
            <h5>Analyze Sales & Optimize Growth</h5>
          </div>
        </div>
      </div>
    ...
    <div class="row g-4 text-center">
      ...
      <div class="col-md-4 col-sm-6">
        <div class="card target-card bg-info-subtle h-100">
          <div class="card-body">
            <i class="bi bi-rocket fs-1 text-info mb-3"></i>
            <h5>D2C Brands</h5>
          </div>
        </div>
      </div>
...
<section class="section cta-section text-center text-white">
  <div class="container">
    ...
    <h2 class="mb-3">Ready to Grow Your Ecommerce Business?</h2>
    
    <p class="mb-4">
      Take full control of your online and offline sales with AllmartX ERP.
    </p>
      ...
      <div class="responsive-flex">
        ...
        <div>
          ...
          <p style="color:#ccc; margin-bottom:0;">
            Build Manage Grow Your Business Easily
          </p>
        </div>
