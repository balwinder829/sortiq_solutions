...
<div class="container">
    ...
    {{-- FILTERS --}}
    <form method="GET"  id="filterForm" action="{{ route('office-cleaning-expenses.index') }}" class="mb-4">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center">
                        ...
                        <a href="{{ route('office-cleaning-expenses.show', $expense->id) }}"
                        ...
                        <form action="{{ route('office-cleaning-expenses.destroy', $expense->id) }}"
                              method="POST"
                              class="d-inline">
                            @csrf
                            @method('DELETE')
