...
@section('content')
<div class="container">
    <h4>Edit CV Record for: {{ $cv->employee_name }}</h4>
    ...
    <form method="POST" action="{{ route('cvs.update', $cv) }}">
        ...
        <div class="row">
            ...
            <div class="form-group col-md-6 mb-3">
                ...
                <input type="text"
                       ...
                       value="{{ old('employee_name', $cv->employee_name) }}"
                       required >
                @error('employee_name')
            ...
            <div class="form-group col-md-6 mb-3">
                ...
                <input type="text"
                       ...
                       value="{{ old('technology', $cv->technology) }}"
                       required >
                @error('technology')
                    <small class="text-danger">{{ $message }}</small>
                @enderror
            ...
            <div class="form-group col-md-4 mb-3">
                ...
                <select name="experience_status"
                        ...
                        required>
                    @php $currentStatus = old('experience_status', $cv->experience_status); @endphp
            ...
            <div class="form-group col-md-4 mb-3">
                ...
                <input type="number"
                       ...
                       value="{{ old('experience_years', $cv->experience_years) }}"
                       min="0"
                       max="99"
                       placeholder="e.g., 3">
            ...
            <div class="form-group col-md-4 mb-3">
                ...
                <select name="hiring_status"
                        ...
                        required>
                    @php $hiringStatus = old('hiring_status', $cv->hiring_status); @endphp
                    <option value="" disabled>-- Select Status --</option>
            ...
            <div class="form-group col-md-6 mb-3">
                ...
                <input type="text"
                       ...
                       value="{{ old('current_job_status', $cv->current_job_status) }}"
            ...
            <div class="form-group col-md-6 mb-3">
                ...
                <input type="text"
                       ...
                       value="{{ old('file_name', $cv->file_name) }}"
                       required
            ...
            <div class="form-group col-md-6 mb-3">
                ...
                <input type="date"
                       ...
                       value="{{ old('last_updated_at', $cv->last_updated_at?->format('Y-m-d')) }}">
            ...
            <div class="form-group col-md-6 mb-3">
                ...
                <input type="url"
                       ...
                       value="{{ old('gdrive_link', $cv->gdrive_link) }}"
                       required
        ...
        <button type="submit" class="btn btn-primary mt-3">Update CV Record</button>
