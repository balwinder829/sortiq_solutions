    ...
    <form method="POST" action="{{ route('employees.store') }}" enctype="multipart/form-data">
        ...
        <div class="row">
            ...
            <div class="form-group col-md-6">
                ...
                <input type="text" name="emp_code" class="form-control @error('emp_code') is-invalid @enderror"
                    value="{{ old('emp_code', $newEmpCode) }}" required oninput="formatEmployeeCode(this)"
            ...
            <div class="form-group col-md-6">
                ...
                <select name="is_married" class="form-control" required>
                    ...
                    <option value="{{ $bg['value'] }}" {{ old('is_married') == $bg['value'] ? 'selected' : '' }}>
                        {{ ucwords($bg['label']) }}
                    </option>
                    @endforeach
                </select>
            ...
            <div class="form-group col-md-6">
                ...
                <select name="gender" class="form-control" required>
                    ...
                    <option value="{{ $bg['value'] }}" {{ old('gender') == $bg['value'] ? 'selected' : '' }}>
                        {{ ucwords($bg['label']) }}
                    </option>
                    @endforeach
                </select>
            ...
            <div class="form-group col-md-6">
                ...
                <select name="work_mode" class="form-control" required>
                    ...
                    <option value="{{ $mode }}" {{ old('work_mode', 'offline') == $mode ? 'selected' : '' }}>
                        {{ ucfirst($mode) }}
                    </option>
                    @endforeach
                </select>
            ...
            <div class="form-group col-md-6">
                ...
                <select name="job_type" id="jobType" class="form-control" required>
                    ...
                    <option value="{{ $type }}" {{ old('job_type', 'full_time') == $type ? 'selected' : '' }}>
            ...
            <div class="form-group col-md-6" id="workingHoursField" style="display: none;">
                ...
                <input type="number" name="working_hours_per_day" class="form-control" step="0.5" min="1"
                    value="{{ old('working_hours_per_day') }}" placeholder="Enter hours (e.g. 4.5)">
            ...
            <div class="form-group col-md-6">
                ...
                <input type="number" name="probation_period"
                    ...
                    value="{{ old('probation_period') }}" required>
            ...
            <div class="form-group col-md-6">
                ...
                <input type="text" name="phone" class="form-control @error('phone') is-invalid @enderror"
                    value="{{ old('phone') }}" required minlength="10" maxlength="10" pattern="[0-9]{10}"
            ...
            <div class="form-group col-md-6">
                ...
                <input type="text" name="alternative_phone"
                    ...
                    value="{{ old('alternative_phone') }}" required minlength="10" maxlength="10" pattern="[0-9]{10}"
                    title="Enter a valid 10-digit mobile number">
            ...
            <div class="form-group col-md-6">
                ...
                <input type="date" name="dob" class="form-control" max="{{ date('Y-m-d') }}" value="{{ old('dob') }}"
                    required>
            </div>
            ...
            <div class="form-group col-md-6">
                ...
                <div id="drop-area" style="border:2px dashed #6b51df;
                            padding:20px;
                            text-align:center;
                            cursor:pointer;
                            border-radius:6px;">
                ...
                <div id="preview" style="margin-top:10px; display:none;">
                    <img id="previewImg" src="" style="max-width:120px;
