...
<div class="container">
    ...
    <form method="POST" action="{{ route('daily-interviews.store') }}">
        @csrf
        ...
        <div class="row">
            ...
            <div class="form-group col-md-6 mb-3">
                ...
                <select name="interview_type"
                        ...
                        required>
                    @php $currentType = old('interview_type'); @endphp
            ...
            <div class="form-group col-md-6 mb-3">
                ...
                <input type="datetime-local"
                       ...
                       value="{{ old('availability_datetime') ? \Carbon\Carbon::parse(old('availability_datetime'))->format('Y-m-d\TH:i') : '' }}">
            ...
            {{-- Interview Status (Default to Scheduled) --}}
            <div class="form-group col-md-6 mb-3">
                ...
                <select name="interview_status"
                        ...
                        required>
                    @php $currentStatus = old('interview_status', 'Scheduled'); @endphp
            ...
            <div class="form-group col-md-6 mb-3">
                ...
                <select name="interview_mode"
                        ...
                        required>
                    @php $currentMode = old('interview_mode'); @endphp
