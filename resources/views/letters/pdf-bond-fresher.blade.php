        ...
        <div style="padding:0 30px;">
            <table width="100%" cellpadding="0" cellspacing="0">
                <tr>
                    <td colspan="2" style="text-align: center;">
                        <h2 style="font-family: 'Katibeh', serif; text-align: center; font-size: 40px; font-weight: 700; color: #2c2e35; margin: 0 0 30px;"><strong>Two-Year Bond Agreement (Fresher)</strong></h2>
                    </td>
                </tr>
            </table>
            @php
            ...
            <table width="100%" cellpadding="0" cellspacing="0" style="margin-top:15px;">
               ...
               <tr>
                ...
                <tr>
                    <td align="left" style="font-size: 14px; line-height: 24px; text-align:left; font-family: 'Inter', sans-serif;">
                        <strong>{{ ucwords($letter->employee->emp_name) }}</strong>, a Fresher/Intern of Sortiq Solutions Pvt. Ltd., hereinafter referred to as “the Employee / Intern”.
                    </td>
                </tr>
                </table>
                <table width="100%" cellpadding="0" cellspacing="0" style="margin-top:15px;">
                       ...
                       <table width="100%" cellpadding="0" cellspacing="0">
                            <tr>
                                ...
                                <td style="font-size: 14px; line-height: 24px;">
                                    ...
                                    • The Employee acknowledges the Company’s significant investment in training and agrees to complete the bond period.<br>
