...
<div class="wrapper">
    <div class="head-shape">
        <img src="{{ public_path('certificate_images/head-shape.png') }}"/>
    </div>
    <div class="head-main">
        <div class="inner-container">
            <div class="head-content">
                <div class="head-flex">
                    <div class="h-logo">
                        <img src="{{ public_path('certificate_images/logo-sortiq.png') }}"/>
                    </div>
                    <div class="h-detials">
                        <ul>
                            <li><img src="{{ public_path('certificate_images/cl.png') }}"/><span>+91 96465 22110<span></li>
                            <li><img src="{{ public_path('certificate_images/email.png') }}"/><span>info@sortiqsolutions.com<span></li>
                            <li><img src="{{ public_path('certificate_images/globe.png') }}"/><span>www.sortiqsolutions.com<span></li>
                        </ul>
                    </div>
                </div>
            </div>
...
he/she worked on. He/she has gained valuable hands-on experience in the area of their interest.</p>
                ...
                <div class="hghlt">
                    ...
                    <div class="hghlt-right">
                        <img src="{{ public_path('certificate_images/certified.png') }}"/>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="footer-shape">
        <img src="{{ public_path('certificate_images/footer-shape-1.png') }}"/>
    </div>
</div>
