	...
	<div class="certi-body">
		<div class="inner-container">
			...
			<div class="bdy-content">
				<p>This is to certify that <strong>Mr./Ms</strong>. {{ ucwords($student->student_name) }} From {{ $collegename }}
Who has undertaken an internship program of {{ $courseName }} under technical department from {{ $sessionStart }} 
to {{ $sessionStart }} in {{ $durationName }} from the company <strong>"Sortiq Solutions Pvt. Ltd."</strong></p>
...
he/she worked on. He/she has gained valuable hands-on experience in the area of their interest.</p>
				...
				<div class="hghlt">
					...
					<div class="hghlt-right">
						<img src="{{ public_path('images/certificates_images/images/certified.png' ) }}"/>
					</div>
				</div>
			</div>
		</div>
	...
	<div class="footer-shape">
		<img src="{{ public_path('images/certificates_images/images/footer-shape-1.png' ) }}"/>
	</div>
</div>
