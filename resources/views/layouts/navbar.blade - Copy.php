               ...
               {{-- Finance --}}
                ...
                <li class="{{ isParent(['admin.helpdesk.*']) }}">
                    ...
                    <ul class="{{ showSubmenu(['admin.helpdesk.*']) }}">
                        <li class="{{ request()->routeIs('admin.helpdesk.technologies.index.*') ? 'mm-active' : '' }}">
                            <a href="{{ route('admin.helpdesk.technologies.index') }}">
                                <i class="fas fa-ban"></i>
                                <span class="nav-text">Technologies</span>
                            </a>
                        </li>

                        <li class="{{ request()->routeIs('admin.helpdesk.technologies.*') ? 'mm-active' : '' }}">
