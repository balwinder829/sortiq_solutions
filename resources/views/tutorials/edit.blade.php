...
@section('content')
<div class="container">
    <h4>Edit Tutorial: {{ $tutorial->title }}</h4>

    <form method="POST" action="{{ route('tutorials.update', $tutorial) }}">
        @csrf
        @method('PUT')
        ...
        <div class="row">
            ...
            <div class="form-group col-md-6 mb-3">
                ...
                <input type="url"
                       ...
                       {{-- Reconstruct the full URL for display in the input field --}}
                       value="{{ old('youtube_url', 'https://youtu.be/' . $tutorial->youtube_id) }}"
                       required
            ...
            <div class="form-group col-md-6 mb-3">
                ...
                <input type="text"
                       ...
                       value="{{ old('technology', $tutorial->technology) }}"
                       required
            ...
            <div class="form-group col-md-6 mb-3">
                ...
                <select name="level"
                    ...
                    @php $currentLevel = old('level', $tutorial->level); @endphp
            ...
            <div class="form-group col-12 mb-3">
                ...
                <textarea name="description"
                          ...
                          rows="4"
                          placeholder="Brief summary of the tutorial content.">{{ old('description', $tutorial->description) }}</textarea>
                @error('description')
                    <small class="text-danger">{{ $message }}</small>
                @enderror
            </div>
        ...
        <button type="submit" class="btn btn-primary mt-3">Update Tutorial</button>
