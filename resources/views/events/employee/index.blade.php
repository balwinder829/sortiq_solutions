...
<h2 class="mb-3">Employee Events</h2>

<a href="{{ route('employee.events.create') }}" class="btn mb-3" style="background-color: #343957; color: white;">
    <i class="fa fa-plus"></i> Add Employee Event
</a>
