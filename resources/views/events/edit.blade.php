...
<form method="POST" action="{{ route('events.update', $event->id) }}" enctype="multipart/form-data">
    ...
    <div class="row mb-4">
        ...
        <div class="col-md-3 mb-3">
            <div class="card" style="border: {{ $event->cover_image == $image->image_path ? '3px solid #6b51df' : '1px solid #ddd' }};">
                <img src="{{ asset($image->image_path) }}"
                     style="width:100%;height:150px;object-fit:cover;">

                <div class="text-center mt-1">

                    {{-- SET AS COVER via AJAX --}}
    ...
    <a href="{{ route('events.show', $event->id) }}" class="btn btn-secondary mt-3">Back</a>
...
function setCover(id){
    fetch(`/admin/event/set-cover/${id}`, {
        method:"POST",
        headers:{
            "X-CSRF-TOKEN":"{{ csrf_token() }}"
        }
