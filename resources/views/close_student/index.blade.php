    ...
    <div class="table-responsive">
        <table id="certificatesTable" class="table table-bordered table-striped">
            ...
            <tr>
                ...
                <th class="text-center">Certificate Sent On</th>
            ...
            <tr>
                ...
                <td>{{ \Carbon\Carbon::parse($student->close_date)->format('d M Y') }}</td>
                ...
                <td class="text-center">
                    <div class="mb-2">
                        ...
                        {{-- Edit --}}
                        <a href="{{ route('close_student.edit',$student->id) }}" class="btn btn-sm" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit Student">
