            ...
            <table width="100%" cellpadding="0" cellspacing="0">
                <tr>
                    <td colspan="2" style="text-align: center;">
                        <h2 style="font-family: 'Katibeh', serif; text-align: center; font-size: 30px; font-weight: 700; color: #2c2e35; margin: 0 0 30px;"><strong>STUDENT TRAINING / INTERNSHIP CONSENT</strong></h2>
                    </td>
                </tr>
            </table>
           @php
                use Carbon\Carbon;
                        ...
                        $joining_date = $letter->joining_date
                            ? \Carbon\Carbon::parse($letter->joining_date)->format('d M Y')
                            : \Carbon\Carbon::now()->format('d M Y');

                        $completion_date = $letter->completion_date
                            ? \Carbon\Carbon::parse($letter->completion_date)->format('d M Y')
                            : \Carbon\Carbon::now()->format('d M Y');
            ...
            <table width="100%" cellpadding="0" cellspacing="0" style="margin-top:35px;">
                <tr>
                    <td colspan="2" style="font-size: 14px; line-height: 24px; padding-bottom:15px; font-family: 'Inter', sans-serif;">
                        Student Name: {{ !empty($letter->student_name) ? ucwords($letter->student_name) : '' }}<br>

                        Father’s Name: {{ !empty($letter->father_name) ? ucwords($letter->father_name) : '' }}<br>

                        College/Institute Name: {{ !empty($collegeOrPlace) ? $collegeOrPlace : '' }}<br>

                        Course/Branch: {{ !empty($letter->course_branch) ? ucwords($letter->course_branch) : '' }}<br>

                        Contact Number: {{ !empty($letter->contact_no) ? $letter->contact_no : '' }}<br>

                        Email ID: {{ !empty($letter->email_id) ? $letter->email_id : '' }}<br>

                        Training/Internship Domain: {{ !empty($letter->training_domain) ? ucwords($letter->training_domain) : '' }}<br>

                        Duration: {{ !empty($letter->training_duration) ? ucwords($letter->training_duration) : '' }}<br>

                        Batch Mode: {{ !empty($letter->batch_mode) ? ucwords($letter->batch_mode) : '' }}<br>

                        Joining Date: {{ !empty($joining_date) ? $joining_date : '' }}<br>

                        Completion Date: {{ !empty($completion_date) ? $completion_date : '' }}<br>
                    </td>
                </tr>

                <tr>
                    <td colspan="2" style="font-size: 14px; line-height: 24px; padding-bottom:15px; font-family: 'Inter', sans-serif;">
                        I, <b>{{ ucwords($letter->student_name) }}</b>, hereby confirm and declare that I have attended the training/internship program conducted by Sortiq Solutions Pvt. Ltd.
                    </td>
                </tr>
                                ...
                                <td style="font-size: 14px; line-height: 24px;">
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="2" style="font-size: 14px; line-height: 24px;padding-bottom:3px; font-family: 'Inter', sans-serif;">
                                            ...
                                            Practical sessions, assignments, projects, and guidance were provided during the training period.
                                        </td>
                                    </tr>
                                ...
                                <td style="font-size: 14px; line-height: 24px;">
                                    <table width="100%" cellpadding="0" cellspacing="0">
                                        ...
                                        <tr>
                                            <td width="12" valign="top">•</td>
                                            <td colspan="2" style="font-size: 14px; line-height: 24px; padding-bottom:3px; font-family: 'Inter', sans-serif;">
                                                I have received proper guidance according to the enrolled program.
                                            </td>
                                        </tr>
                                ...
                                <td style="font-size: 14px; line-height: 24px;">
                                    ...
                                    <table width="100%" cellpadding="0" cellspacing="0">
                                        ...
                                        <tr>
                                            <td width="12" valign="top">•</td>
                                            <td colspan="2" style="font-size: 14px; line-height: 24px; padding-bottom:3px; font-family: 'Inter', sans-serif;">
                                                I confirm that no pending doubt, syllabus, project, task, or support issue remains from my side before signing this form.
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="2" style="font-size: 14px; line-height: 24px; padding-bottom:3px; font-family: 'Inter', sans-serif;">
                                                OR<br>
                                                Pending items (if any) are mentioned below before signing:
                                            </td>
                                        </tr>
