        ...
        <div class="inner-container" style="padding-left: 30px; padding-right: 30px;">
            ...
            @php
                use Carbon\Carbon;
                        ...
                        $format = 'd F Y';
                         $sessionStart = $letter?->sessionData?->start_date
                            ? Carbon::parse($letter->sessionData->start_date)->format($format)
                            : '';

                        $sessionEnd = $letter?->sessionData?->end_date
                            ? Carbon::parse($letter->sessionData->end_date)->format($format)
                            : '';
