...
@endif
    ...
    {{-- Top summary boxes --}}
    @hasanyrole('Admin|Manager|HR|Custom')
<div class="row g-3 mb-4">
         ...
         <a href="{{ route('students.index') }}" class="text-decoration-none text-dark">
            <div class="card text-center shadow-sm h-100">
                <div class="card-body">
                    ...
                    <h3 class="fw-bold">{{ $allstudents->total_students }}</h3>
                </div>
            </div>
        </a>
    </div>
         ...
         <a href="{{ route('students.index') }}" class="text-decoration-none text-dark">
            <div class="card text-center shadow-sm h-100">
                <div class="card-body">
                    ...
                    <h3 class="fw-bold">{{ $allstudents->online_students ?? 0 }}</h3>
                </div>
            </div>
        </a>
    </div>
         ...
         <a href="{{ route('students.index') }}" class="text-decoration-none text-dark">
            <div class="card text-center shadow-sm h-100">
                <div class="card-body">
                    ...
                    <h3 class="fw-bold">{{ $allstudents->offline_students ?? 0 }}</h3>
                </div>
            </div>
        </a>
    </div>
        ...
        <a href="#" class="text-decoration-none text-dark">
            <div class="card text-center shadow-sm h-100">
                <div class="card-body">
                    ...
                    <h3 class="fw-bold">{{ $totalEmployye }}</h3>
                </div>
            </div>
        </a>
    </div>
    ...
    <div class="col-12 col-md-3">
        <a href="#" class="text-decoration-none text-dark">
            <div class="card text-center shadow-sm h-100">
                <div class="card-body">
                    <h6 class="text-muted">Total Sale Employee</h6>
                    <h3 class="fw-bold">{{ $totalSaleEmployye }}</h3>
                </div>
            </div>
        </a>
    </div>
   ...
   <!--  <div class="col-12 col-md-3">
        <a href="#" class="text-decoration-none text-dark">
            <div class="card text-center shadow-sm h-100">
                <div class="card-body">
                    <h6 class="text-muted">Highest Fee</h6>
                    <h3 class="fw-bold">{{ $highestFeeStudent }} </h3>
                </div>
            </div>
        </a>
    </div> -->
