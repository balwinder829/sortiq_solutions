...
<div class="container">
    ...
    {{-- Header --}}
     ...
     <div class="row mb-2">
        <div class="col-md-10">
            <h1 class="page_heading">Single Products Request</h1>
        </div>
         
        <div class="col-md-2">
            <div class="d-flex justify-content-end">
                <a href="{{ route('single-product-registrations.index') }}" class="btn mb-3" style="background-color: #6b51df; color: #fff;">Back </a>
            </div>
        </div>
    </div>
