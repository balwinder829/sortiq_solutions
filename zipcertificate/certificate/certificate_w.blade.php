...
<div class="wrapper">
	<div class="head-shape">
		<img src="{{ public_path('certificate_images/images/head-shape.png')}}"/>
	</div>
	<div class="head-main">
		<div class="inner-container">
			<div class="head-content">
				<div class="head-flex">
					<div class="h-logo">
						<img src="{{ public_path('certificate_images/images/logo-sortiq.png') }}"/>
					</div>
					<div class="h-detials">
						<ul>
							<li><img src="{{ public_path('certificate_images/images/cl.png') }}"/><span>+91 96465 22110<span></li>
							<li><img src="{{ public_path('certificate_images/images/email.png') }}"/><span>info@sortiqsolutions.com<span></li>
							<li><img src="{{ public_path('certificate_images/images/globe.png') }}"/><span>www.sortiqsolutions.com<span></li>
						</ul>
					</div>
				</div>
			</div>
	...
	<div class="certi-body">
		<div class="inner-container">
			...
			<div class="bdy-sr">
				<div class="sr-left">
					<p>S.No______________________________</p>
				</div>
				<div class="sr-right">
					<p>Date______________________________</p>
				</div>
			</div>
			<div class="bdy-content">
				<p>This is to certify that <strong>Mr./Ms</strong>. ..............................................................From..............................................................
Who has undertaken an internship program of .................................... under technical department from ...............
to ............................................ in ............................................ from the company <strong>"Sortiq Solutions Pvt. Ltd."</strong></p>
...
he/she worked on. He/she has gained valuable hands-on experience in the area of their interest.</p>
				...
				<div class="hghlt">
					...
					<div class="hghlt-right">
						<img src="{{ public_path('certificate_images/images/certified.png') }}"/>
					</div>
				</div>
			</div>
		</div>
	...
	<div class="footer-shape">
		<img src="{{ public_path('certificate_images/images/footer-shape-1.png') }}"/>
	</div>
</div>
