...
<title>BlogerzWorld | Sortiq Solutions Pvt Ltd</title>
  ...
  <div class="container">
    ...
    <div class="row align-items-center g-5">
      ...
      <div class="col-md-6">
        ...
        <h2 class="section-title mb-3">
          ...
          Your Complete Blogging & Content Management Platform
        ...
        <p>
          ...
          <strong>BlogerzWorld</strong> by <strong>SortIQ Solutions</strong>is a powerful blogging ERP designed for content creators, agencies, and businesses.
        ...
        <p>
          ...
          It simplifies blog publishing, content management, SEO optimization, and team collaboration—all from one centralized dashboard.
    ...
    <div class="text-center mt-5">
      ...
      <p class="fw-semibold">
        ...
        👉  Modern blogging platforms help creators manage content, collaborate, and optimize for SEO to reach wider audiences.
    ...
    <div class="row g-4">
      ...
      <div class="col-md-4 col-sm-6">
        ...
        <div class="card h-100 text-center shadow-sm p-3">
          ...
          <p>Blog Creation & Publishing System</p>
      ...
      <div class="col-md-4 col-sm-6">
        ...
        <div class="card h-100 text-center shadow-sm p-3">
          ...
          <p>Multi-Author & Role Management</p>
      ...
      <div class="col-md-4 col-sm-6">
        ...
        <div class="card h-100 text-center shadow-sm p-3">
          ...
          <p>Content Scheduling & Draft Management</p>
      ...
      <div class="col-md-4 col-sm-6">
        ...
        <div class="card benefit-card border-primary h-100 text-center">
          ...
          <div class="card-body">
            ...
            <i class="bi bi-pencil fs-1 text-primary mb-3"></i>

            <h5>Easy Content Creation</h5>

            <p>Create and publish blogs with a simple editor</p>
      ...
      <div class="col-md-4 col-sm-6">
        ...
        <div class="card benefit-card border-success h-100 text-center">
          ...
          <div class="card-body">
            ...
            <h5>Multi-Author Management</h5>

            <p>Manage writers, editors, and roles efficiently</p>
      ...
      <div class="col-md-4 col-sm-6">
        ...
        <div class="card benefit-card border-warning h-100 text-center">
          ...
          <div class="card-body">
            ...
            <p>Optimize blogs for better search rankings</p>
      ...
      <div class="col-md-4 col-sm-6">
        ...
        <div class="card benefit-card border-danger h-100 text-center">
          ...
          <div class="card-body">
            ...
            <p>Plan and publish content automatically</p>
      ...
      <div class="col-md-4 col-sm-6">
        ...
        <div class="card benefit-card border-info h-100 text-center">
          ...
          <div class="card-body">
            ...
            <p>Track views, engagement, and growth</p>
      ...
      <div class="col-md-4 col-sm-6">
        ...
        <div class="card benefit-card border-dark h-100 text-center">
          ...
          <div class="card-body">
            ...
            <h5>Fast Publishing</h5>

            <p>Publish blogs instantly with optimized workflow</p>
    ...
    <div class="row g-4">
      ...
      <div class="col-md-4 col-sm-6">
        ...
        <div class="card h-100 text-center shadow-sm p-3">
          ...
          <h5>SEO-Friendly Structure</h5>

          <p>SEO-Friendly Blog Structure</p>
      ...
      <div class="col-md-4 col-sm-6">
        ...
        <div class="card h-100 text-center shadow-sm p-3">
          ...
          <i class="bi bi-speedometer2 fs-1 mb-3 text-info"></i>
      ...
      <div class="col-md-4 col-sm-6">
        ...
        <div class="card target-card bg-primary-subtle h-100">
          ...
          <div class="card-body">
            ...
            <h5>Bloggers & Content Creators</h5>
      ...
      <div class="col-md-4 col-sm-6">
        ...
        <div class="card target-card bg-warning-subtle h-100">
          ...
          <div class="card-body">
            ...
            <i class="bi bi-rocket fs-1 text-warning mb-3"></i>
      ...
      <div class="col-md-4 col-sm-6">
        ...
        <div class="card target-card bg-danger-subtle h-100">
          ...
          <div class="card-body">
            ...
            <i class="bi bi-newspaper fs-1 text-danger mb-3"></i>

            <h5>Media & Publishing Companies</h5>
...
<section class="section cta-section text-center text-white">
  ...
  <div class="container">
    ...
    <h2 class="mb-3">Start Your Blogging Journey Today</h2>

    

    <p class="mb-4">

      Create high-quality content, improve SEO, and grow your audience with BlogerzWorld.
      ...
      <div class="responsive-flex">
        ...
        <div>
          ...
          <p style="color:#ccc; margin-bottom:0;">
            ...
            One Platform for All Your Blogs
